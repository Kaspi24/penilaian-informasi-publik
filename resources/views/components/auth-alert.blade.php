<div class="">
    @if (session('success'))
        <div class="max-w-[76rem] mt-4 mx-auto">
            <div id="alertMessage" class="flex items-center p-2 bg-green-200 rounded-sm" role="alert">
                ...
                <div class="ml-2 text-xs font-medium text-green-700">
    ...
    @if (session('failed'))
        <div class="max-w-[76rem] mt-4 mx-auto">
            <div id="alertMessage" class="flex items-center p-2 bg-red-200 rounded-sm" role="alert">
                ...
                <span class="sr-only">Info</span>
                <div class="ml-2 text-xs font-medium text-red-700">
    ...
    @if (session('warning'))
        <div class="max-w-[76rem] mt-4 mx-auto">
            <div id="alertMessage" class="flex items-center p-2 bg-yellow-200 rounded-sm" role="alert">
                ...
                <span class="sr-only">Info</span>
                <div class="ml-2 text-xs font-medium text-yellow-700">
